...
public class ReplyDAOImpl implements ReplyDAO{
	...
	private static final String NAMESPACE = "com.thugdev.mypage.mappers.reply.ReplyMapper"; 
	...
	@Override
	public void deleteAll(Integer article_no) throws Exception {
		sqlSession.delete(NAMESPACE+".deleteAll",article_no);
	}
}
