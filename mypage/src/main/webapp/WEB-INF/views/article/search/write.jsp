        		...
        		<div class="card"> 
        			...
        			<div class="card-body"> 
        				<div class="form-group"> 
        					...
        					<input class="form-control" id="title" name="title" placeholder="타겟스케줄/업체명 기재, 물품사진 첨부 가능"> 
        				</div> 
        				<div class="form-group"> 
        					<label for="content">내용</label> 
        					<textarea class="form-control" id="content" name="content" rows="30" placeholder="물품명/패킹/사이즈/수량/총중량/HS CODE/위험물 여부 &#13;&#10;기재 필수 !" style="resize: none;"></textarea> 
        				</div> 
        				<div class="form-group"> 
