        		...
        		<div class="card-body"> 
        			<table class="table table-bordered"> 
        				...
        				<tr> 
        					...
        					<td>
        						<a href="${path}/article/paging/search/read${pageMaker.makeSearch(pageMaker.criteria.page)}&article_no=${article.article_no}">${article.title}</a>
        			...
        			<nav aria-label="Contacts Page Navigation"> 
        				<ul class="pagination justify-content-center m-0"> 
        					<c:if test="${pageMaker.prev}"> 
        						<li class="page-item"><a class="page-link" href="${path}/article/paging/search/list${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
        					</c:if> 
        					...
        					<c:if test="${pageMaker.next && pageMaker.endPage > 0}"> 
        						<li class="page-item"><a class="page-link" href="${path}/article/paging/search/list?${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li> 
        					</c:if> 
        				</ul> 
        			</nav> 
        		</div>
        			...
        			<div class="row"> 
        				<div class="form-group col-sm-2"> 
        					<select class="form-control" name="searchType" id="searchType"> 
        						<option value="n" <c:out value="${searchCriteria.searchType == null ? 'selected' : ''}"/>>검색 조건</option> 
...
<script>
	$(document).ready(function () {
    	...
    	$("#writeBtn").on("click", function (event) {
        	self.location =
            	"${path}/article/paging/search/write"
    	});
	});
</script>
</body>
