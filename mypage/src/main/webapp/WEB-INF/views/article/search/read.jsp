	      	...
	      	<form class="form-horizontal"> 
	      		<div class="row"> 
	      			<div class="form-group col-sm-8"> 
	      				<input class="form-control input-sm" id="newReplyText" type="text" placeholder="댓글 입력하세요"> 
	      			</div> 
...
<script id="replyTemplate" type="text/x-handlebars-template">
    ...
    <div class="post replyDiv" data-reply_no={{reply_no}}>
        <div class="user-block">
			...
			<span>{{prettifyDate reg_date}}</span>
...
<script>
	...
	$(document).ready(function () { 
		...
		function printReplyCount(totalCount) { 
			...
			collapsedBox.find(".box-tools").html( "<button type='button' class='btn btn-box-tool' data-widget='collapse'>" 
					+ "<i class='fa fa-plus'></i>" 
					+ "</button>" ); 
			} 
